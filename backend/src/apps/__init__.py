...
from src.apps.system.routes import kiosk_router, network_router

apps_router = APIRouter(prefix="/api/v1")

apps_router.include_router(admin_router)
apps_router.include_router(schedule_image_router)
apps_router.include_router(local_schedule_image_router)
apps_router.include_router(network_router)
apps_router.include_router(kiosk_router)
